 ...
 *
 * The Vertex Class represents a Vertex of the graph. It has a vertex_id that is
 * unique and is equal to the vertexArray index that holds the Vertex. The
 * outDegree is equal to the number of outbound edges from this Vertex. The
 * AdjacencyList holds a list of the vertices to which this vertex connects to.
 *
